...
namespace bicycle
{
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    if (Session["Buyitems"] == null)
                    {
                        ...
                        String myquery = "select * from protable where proid=" + Request.QueryString["id"];
                        ...
                        da.Fill(ds);
                        dr["sno"] = 1;
                        dr["proid"] = ds.Tables[0].Rows[0]["prodid"].ToString();
                        dr["proname"] = ds.Tables[0].Rows[0]["proname"].ToString();
                        dr["proimg"] = ds.Tables[0].Rows[0]["proimg"].ToString();
                    ...
                    else
                    {
                        ...
                        String mycon = "Data Source=.\\SQLEXPRESS;AttachDbFilename=C:\\Users\\Prachi\\Documents\\Visual Studio 2010\\Projects\\bicycle\\bicycle\\App_Data\\bicycledetail3.mdf;Integrated Security=True;User Instance=True";
                        SqlConnection scon = new SqlConnection(mycon);
                        String myquery = "select * from protable where prodid=" + Request.QueryString["id"];
                        SqlCommand cmd = new SqlCommand();
                        cmd.CommandText = myquery;
                        cmd.Connection = scon;
                        SqlDataAdapter da = new SqlDataAdapter();
         ...
         protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        Response.Redirect("cart1.aspx");
         ...
         {
             Response.Redirect("updateorder.aspx?sno=" + GridView1.SelectedRow.Cells[0].Text);
         }
